...
@Component({
  selector: 'app-student-complete-report',
  templateUrl: './student-complete-report.component.html',
  styleUrls: ['./student-complete-report.component.css']
})
export class StudentCompleteReportComponent implements OnInit {
